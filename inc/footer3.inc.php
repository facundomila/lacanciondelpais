...
<div id="publi1" class="publi">
<a href="notas/literatura/poetas-del-pais/"><img src="img/banner-poetas.jpg" width="195" height="128"></a>
</div>

<div class="publi">
<ul class="rotation">
<li><a href="http://www.plataformalavarden.com.ar/" target="_blank"><img src="publicidad/lavarden-2014-12.png" width="195" height="322"  alt=""/></a></li>
</ul>
</div>
...
<?php	
	...
	$C=mysql_query ("SELECT posts.Id, posts.link, seccionID, secciones.link AS sLink, secciones.seccion, subseccionID, titulo, bajada FROM posts, secciones WHERE secciones.id=seccionID ORDER BY fecha DESC, posts.Id DESC LIMIT 0, 3") or printf(mysql_error());
